...
ソート：<a href="/jmaster2/ItemServlet?action=sort&key=price_asc">値段の低い順</a> ,
<a href="/jmaster2/ItemServlet?action=sort&key=price_desc">値段の高い順</a><br>

<form action="/jmaster2/ItemServlet" method="post">
